  ...
  const destinations = [
    {
      ...
      highlights: ["Blue Dome Churches", "Sunset Views", "Wine Tasting"],
      description:
        "Experience the magical sunsets and whitewashed buildings of Greece's most romantic island.",
    },
    {
      id: 2,
      name: "Bali, Indonesia",
      ...
      highlights: ["Rice Terraces", "Temple Tours", "Beach Relaxation"],
      description:
        "Discover the perfect blend of culture, spirituality, and tropical paradise.",
    },
    {
      id: 3,
      name: "Maldives",
      ...
      highlights: ["Overwater Villas", "Snorkeling", "Spa Treatments"],
      description:
        "Luxury meets paradise in this collection of pristine coral islands.",
    },
    {
      id: 4,
      name: "Tokyo, Japan",
      ...
      highlights: ["Cherry Blossoms", "Sushi Experience", "Temple Visits"],
      description:
        "Immerse yourself in the perfect harmony of ancient traditions and modern innovation.",
    },
    {
      id: 5,
      name: "Dubai, UAE",
      ...
      highlights: ["Burj Khalifa", "Desert Safari", "Luxury Shopping"],
      description:
        "Experience the ultimate luxury destination where dreams become reality.",
    },
    {
      id: 6,
      name: "Iceland",
      ...
      highlights: ["Northern Lights", "Hot Springs", "Glacier Tours"],
      description:
        "Witness nature's most spectacular phenomena in the land of fire and ice.",
    },
    {
      id: 7,
      name: "Paris, France",
    ...
    },
    {
      ...
      highlights: ["Broadway Shows", "Central Park", "Statue of Liberty"],
      description:
        "Experience the energy and excitement of the city that never sleeps.",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      name: "Sarah Johnson",
      feedback:
        "Amazing experience! The team helped us plan the perfect honeymoon in Santorini. Every detail was perfect.",
      rating: 5,
      location: "New York, USA",
      avatar:
    ...
    },
    {
      ...
      name: "Michael Chen",
      feedback:
        "Professional service and incredible destinations. Our family trip to Bali was unforgettable!",
      rating: 5,
      location: "Toronto, Canada",
      avatar:
    ...
    },
    {
      ...
      name: "Emma Rodriguez",
      feedback:
        "Best travel agency ever! They made our dream vacation to the Maldives come true within our budget.",
      rating: 5,
      location: "Madrid, Spain",
      avatar:
  ...
  const filteredDestinations = destinations
    .filter((destination) => {
      const matchesSearch =
        ...
        destination.location.toLowerCase().includes(searchQuery.toLowerCase());
      const matchesFilter =
        selectedFilter === "All" || destination.location === selectedFilter;
      return matchesSearch && matchesFilter;
    })
    .slice(0, visibleDestinations);
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full bg-gray-900/95 backdrop-blur-sm z-50 border-b border-gray-800 transition-all duration-300">
            ...
            <div className="hidden md:flex space-x-8 items-center">
              ...
              <div className="relative">
                <button
                  ...
                  className="relative p-2 hover:text-blue-400 transition-colors duration-300 flex items-center gap-2"
                >
                ...
                {/* Wishlist Dropdown */}
                {showWishlist && (
                  <div className="absolute right-0 top-full mt-2 w-80 bg-gray-800 border border-gray-700 rounded-xl shadow-2xl z-50 animate-fadeIn">
                    <div className="p-4 border-b border-gray-700">
                      <h3 className="text-lg font-semibold text-white">
                        My Wishlist
                      </h3>
                      <p className="text-sm text-gray-400">
                        {favorites.size} destination
                        {favorites.size !== 1 ? "s" : ""}
                      </p>
                    </div>
                    ...
                    <div className="max-h-96 overflow-y-auto">
                      {getWishlistItems().length === 0 ? (
                        <div className="p-6 text-center text-gray-400">
                          ...
                          <p className="text-sm">Add destinations you love!</p>
                        </div>
                      ) : (
                        getWishlistItems().map((destination) => (
                          <div
                            key={destination.id}
                    ...
                    {getWishlistItems().length > 0 && (
                      <div className="p-4 border-t border-gray-700">
                        <button
                          ...
                          className="w-full px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg text-white text-sm font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-300"
                        >
        ...
        {/* Mobile Menu */}
        <div
          className={`md:hidden bg-gray-900/98 backdrop-blur-sm border-t border-gray-800 transition-all duration-500 ${
        ...
        >
          <div className="px-4 py-4 space-y-4">
            ...
            <button
              onClick={() => setShowWishlist(!showWishlist)}
              className="flex items-center gap-2 w-full text-left hover:text-blue-400 transition-colors duration-300"
            >
      ...
      {showWishlist && (
        <div className="md:hidden fixed inset-0 z-50 bg-black/50 backdrop-blur-sm animate-fadeIn">
          <div className="absolute bottom-0 left-0 right-0 bg-gray-800 rounded-t-2xl max-h-[80vh] animate-slideInFromBottom">
            <div className="p-4 border-b border-gray-700 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">
                  {favorites.size} destination{favorites.size !== 1 ? "s" : ""}
                </p>
              </div>
              <button
                onClick={() => setShowWishlist(false)}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto animate-slideInFromRight">
              Discover the most sought-after destinations handpicked by our
              travel experts
            </p>
          </div>
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 bg-gradient-to-r from-red-500 to-pink-500 rounded-full px-3 py-1 text-sm font-semibold">
                    Save $
                    {parseInt(destination.originalPrice.slice(1)) -
                      parseInt(destination.price.slice(1))}
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br ${feature.color} rounded-full mb-6 group-hover:shadow-2xl group-hover:shadow-blue-500/25 transition-all duration-300 animate-pulse`}
                >
      ...
      {/* Footer */}
      <footer
        className="bg-gray-900 border-t border-gray-800 py-16 px-4"
        id="footer"
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="animate-slideInFromLeft">
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                Creating unforgettable travel experiences around the world since
                2020.
              </p>
              <div className="flex space-x-4">
                ...
                <a
                  href="#"
                  className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-pink-600 transition-all duration-300 transform hover:scale-110"
                >
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            ...
            <p className="mb-2">
              ...
              <a
                href="#"
                className="hover:text-white transition duration-300 ml-1"
              >
                Terms of Service
              </a>
            </p>
            <p className="text-xs italic text-gray-500 mt-4">
              ...
              <span className="text-white font-medium">Ravi</span> — Thanks for
